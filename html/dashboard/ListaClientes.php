  ...
  <body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/index2.html" class="navbar-brand">
                <!--Logo start-->
                <!--logo End-->
                ...
                <!--logo End-->               
                <h6 class="logo-title">ADMINISTRADOR</h6>
            </a>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
             <div class="sidebar-list">
                <!-- Barra del menu inicia -->
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">MONITOREO</span>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">SOLICITUDES</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../html/dashboard/ListaSolicitudes.html">
                            <i class="icon">
                            ...
                            <span class="item-name">Guias</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../html/dashboard/Horario.html">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../../html/dashboard/ListaClientes.php">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <!-- Carrocería del tren -->
                                    <rect x="2" y="8" width="20" height="6" rx="3" fill="currentColor"></rect>
                                    <!-- Ruedas traseras -->
                                    <circle cx="6" cy="18" r="3" fill="currentColor"></circle>
                                    <circle cx="18" cy="18" r="3" fill="currentColor"></circle>
                                    <!-- Parte frontal -->
                                    <rect x="20" y="8" width="2" height="6" rx="1" fill="currentColor"></rect>
                                </svg>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../html/dashboard/ListaComercio.php">
                            ...
                            <span class="item-name">Comercios</span>
                        </a>
                    </li>
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">RECLAMOS</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="reclamosClientes.html">
                                   <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="reclamosGuias.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
      ...
      <div class="position-relative iq-banner">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            <a href="../dashboard/index2.html" class="navbar-brand">
                ...
                <h5 class="logo-title">Administrador</h5>
            </a>
            <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                <i class="icon">
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">Alexandro Sanchez</h6>
        ...
        </nav>          <!-- Inicio del titulo de la pagina -->
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="flex align-items-center list-user-action">
                                 <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Visualizar"  href="VisualizarCliente.php">
      ...
      <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> TrenGo, Made with
                  <span class="">
                  ...
                  </span> by <a href="https://iqonic.design/">Alexandro Studio</a>.
              </div>
          </div>
      </footer>
